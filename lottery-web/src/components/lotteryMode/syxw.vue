<template>
  <div class="lottery-wrap syxw-wrap-inner" v-loading="loaded">
        ...
        <div style="min-height:520px;">
          ...
          <div class="bets-wrap-parent">
            <div class="bets-wrap">
              ...
              <betsAreaTen lotteryType="syxw" v-if="randerbetsAreaTen&&betsArr.type!=='text'" :betsArr="betsArr" @sendWei="handlesendWei"></betsAreaTen>
              ...
              <table style="width:100%">
                ...
                <tbody>
                  <tr v-for="(item, index) in betsDataList" :key="index">
                    ...
                    <!-- <th>0.5%</th> -->
                    <th>{{Number(item.vote_cash).toFixed(2)}}</th>
                    <th :class="item.status==5?'zhongjiangMoney':''">{{Number(item.award_cash).toFixed(2)}}</th>
                    <th>{{item.refund}}</th>
              ...
              <table style="width:100%">
                ...
                <tbody>
                  <tr v-for="(item, index) in chaseDataList" :key="index">
                    ...
                    <!-- <th>注数比例</th> -->
                    <th>{{Number(item.total_vote_cash).toFixed(2)}}</th>
                    <th>{{Number(item.vote_cash_finished).toFixed(2)}}</th>
                    <th>{{Number(item.award_cash).toFixed(2)}}</th>
                    <th>{{Number(item.vote_cash_canceled).toFixed(2)}}</th>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        threeCode: [
        {
          title: '直选',
          data: [
            { title: '前三直选复式', type: 'three', showOprateBtn: true, checked: true, unit: 1, betsTitle: ['一位', '二位', '三位'], betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            { title: '前三直选单式', type: 'text', checked: false, checkBit: false, numLen: 3, isDouble: 2, order: false, valueLen: 0 }, // isDouble 0 三个值都不能一样, 1 可以有两个一样, 2 可以都一样, 3必须有两个值一样
          ]
        },
        {
          title: '组选',
          data: [
            { title: '前三组选复式', type: 'single', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['前三'], betsMode: 3, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            { title: '前三组选单式', type: 'text', checked: false, checkBit: false, numLen: 3, isDouble: 3, order: true, valueLen: 0 }, // isDouble 0 三个值都不能一样, 1 可以有两个一样, 2 可以都一样, 3必须有两个值一样
            { title: '前三组选胆拖', type: 'dantuo', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['胆码', '拖码'], danNum: 2, betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false, valueLen: 3 }
          ]
        }],
        twoCode: [
        {
          title: '直选',
          data: [
            { title: '前二直选复式', type: 'double', showOprateBtn: true, checked: true, unit: 1, betsTitle: ['一位', '二位'], doubleArr: [1, 1], betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
        ...
        },
        {
          title: '组选',
          data: [
            { title: '前二组选复式', type: 'single', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['前二'], betsMode: 2, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            ...
            { title: '前二组选胆拖', type: 'dantuo', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['胆码', '拖码'], danNum: 1, betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false, valueLen: 3 }
          ]
        }],
        nonPos: [
        {
          title: '不定位',
          data: [
            { title: '前三不定位', type: 'end', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['前三'], betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false }
          ]
        }, ],
        interest: [
        {
          title: '趣味型',
          data: [
            { title: '定单双', type: 'interest-end', showOprateBtn: true, checked: true, unit: 1, betsTitle: [''], betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            { title: '猜中位', type: 'cai-end', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['猜中位'], betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
          ]
        }],
        posDan: [
        {
          title: '定位胆',
          data: [
            { title: '定位胆', type: 'position', showOprateBtn: true, checked: true, unit: 1, betsTitle: ['一位', '二位', '三位'], betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: true, checkBit: false }
          ]
        }],
        optional1: [
        {
          title: '任选复式',
          data: [
            { title: '任选一中一复式', type: 'end', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['选1中1'], betsMode: 2, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            { title: '任选二中二复式', type: 'single', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['选2中2'], betsMode: 2, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            { title: '任选三中三复式', type: 'single', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['选3中3'], betsMode: 3, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            { title: '任选四中四复式', type: 'single', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['选4中4'], betsMode: 4, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            { title: '任选五中五复式', type: 'single', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['选5中5'], betsMode: 5, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            { title: '任选六中五复式', type: 'single', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['选6中5'], betsMode: 6, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            { title: '任选七中五复式', type: 'single', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['选7中5'], betsMode: 7, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            { title: '任选八中五复式', type: 'single', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['选8中5'], betsMode: 8, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false }
          ]
        }],
        optional2: [
        {
          title: '任选单式',
          data: [
            { title: '任选一中一单式', type: 'text', betsTitle: ['选1中1'], numLen: 1, checked: false, checkBit: false, isDouble: 0, order: true, valueLen: 0 },
            { title: '任选二中二单式', type: 'text', betsTitle: ['选2中2'], numLen: 2, checked: false, checkBit: false, isDouble: 0, order: true, valueLen: 0 },
            { title: '任选三中三单式', type: 'text', betsTitle: ['选3中3'], numLen: 3, checked: false, checkBit: false, isDouble: 0, order: true, valueLen: 0 },
            { title: '任选四中四单式', type: 'text', betsTitle: ['选4中4'], numLen: 4, checked: false, checkBit: false, isDouble: 0, order: true, valueLen: 0 },
            { title: '任选五中五单式', type: 'text', betsTitle: ['选5中5'], numLen: 5, checked: false, checkBit: false, isDouble: 0, order: true, valueLen: 0 },
            { title: '任选六中五单式', type: 'text', betsTitle: ['选6中5'], numLen: 6, checked: false, checkBit: false, isDouble: 0, order: true, valueLen: 0 },
            { title: '任选七中五单式', type: 'text', betsTitle: ['选7中5'], numLen: 7, checked: false, checkBit: false, isDouble: 0, order: true, valueLen: 0 },
            { title: '任选八中五单式', type: 'text', betsTitle: ['选8中5'], numLen: 8, checked: false, checkBit: false, isDouble: 0, order: true, valueLen: 0 }
          ]
        }],
        optional3: [
        {
          title: '任选胆拖',
          data: [
            { title: '任选二中二胆拖', type: 'dantuo', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['胆码', '拖码'], danNum: 1, betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false, valueLen: 3 },
            { title: '任选三中三胆拖', type: 'dantuo', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['胆码', '拖码'], danNum: 2, betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false, valueLen: 3 },
            { title: '任选四中四胆拖', type: 'dantuo', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['胆码', '拖码'], danNum: 3, betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false, valueLen: 3 },
            { title: '任选五中五胆拖', type: 'dantuo', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['胆码', '拖码'], danNum: 4, betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false, valueLen: 3 },
            { title: '任选六中五胆拖', type: 'dantuo', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['胆码', '拖码'], danNum: 5, betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false, valueLen: 3 },
            { title: '任选七中五胆拖', type: 'dantuo', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['胆码', '拖码'], danNum: 6, betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false, valueLen: 3 },
            { title: '任选八中五胆拖', type: 'dantuo', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['胆码', '拖码'], danNum: 7, betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false, valueLen: 3 },
          ]
        }],
      }
    },
    created() {
      ...
      this.$store.dispatch('setbodyBG', 'syxw');
      localStorage.setItem('bodyBG', 'syxw');
    },
    beforeDestroy() {
    ...
    methods: {
      ...
      handleChangeNav(item) {
        ...
        if (item.title === '三码') {
          this.initData(this.threeCode);
        } else if (item.title === '二码') {
          this.initData(this.twoCode);
        } else if (item.title === '不定位') {
          this.initData(this.nonPos);
        } else if (item.title === '趣味型') {
          this.initData(this.interest);
        } else if (item.title === '定位胆') {
          this.initData(this.posDan);
        } else if (item.title === '任选复式') {
          this.initData(this.optional1);
        } else if (item.title === '任选单式') {
          this.initData(this.optional2);
        } else if (item.title === '任选胆拖') {
          this.initData(this.optional3);
        }
      },
      // 获取从模块中返回的 投注的 数据
      handlesendBetsArr(data) {
        ...
        try {
          ...
          if (this.moneyType === '元') {
            ...
            vm.prize = prize * 0.1
            vm.c_prize = prize * 0.1
          } else if (vm.moneyType === '分') {
            vm.prize = prize * 0.01
            vm.c_prize = prize * 0.01
          }
        } catch (e) {}
      },
      // 清除投注号
      ...
      getBetsNumber(val) {
        ...
        if (this.betsArr.type === 'text') {
          ...
          this.betsNumber = textBetsArr.join("|")
        } else {
          var data = this.betsArr.data;
          var arr = [];
          for (let i in data) {
      ...
      handleClickShop(item) {
        ...
        if (item.name.indexOf('单式') > -1) {
          ...
          if (arr[0] === '三码') {
            vm.filterShoppingCart(item, vm.threeCode);
          } else if (arr[0] === '二码') {
            vm.filterShoppingCart(item, vm.twoCode)
          } else if (arr[0] === '不定位') {
            vm.filterShoppingCart(item, vm.nonPos)
          } else if (arr[0] === '趣味型') {
            vm.filterShoppingCart(item, vm.interest)
          } else if (arr[0] === '定位胆') {
            vm.filterShoppingCart(item, vm.posDan)
          } else if (arr[0] === '任选复式') {
            vm.filterShoppingCart(item, vm.optional1)
          } else if (arr[0] === '任选单式') {
            vm.filterShoppingCart(item, vm.optional2)
          } else if (arr[0] === '任选胆拖') {
            vm.filterShoppingCart(item, vm.optional3)
          }
        }
      },
      ...
      setInitData(data) {
        ...
        data.filter((v, vi) => {
          ...
          vm.navData.push(o);
          if (v.name === '三码') {
            vm.filterLotteryList(v.children, vm.threeCode, v);
          } else if (v.name === '二码') {
            vm.filterLotteryList(v.children, vm.twoCode, v);
          } else if (v.name === '不定位') {
            vm.filterLotteryList(v.children, vm.nonPos, v);
          } else if (v.name === '趣味型') {
            vm.filterLotteryList(v.children, vm.interest, v);
          } else if (v.name === '定位胆') {
            vm.filterLotteryList(v.children, vm.posDan, v);
          } else if (v.name === '任选复式') {
            vm.filterLotteryList(v.children, vm.optional1, v);
          } else if (v.name === '任选单式') {
            vm.filterLotteryList(v.children, vm.optional2, v);
          } else if (v.name === '任选胆拖') {
            vm.filterLotteryList(v.children, vm.optional3, v);
          }
        })
        this.loaded = false;
      ...
      confirmLotteryFn() {
        ...
        if (allBets != 0) {
          ...
          vm.shoppingCart.filter(v => {
            vote_no = v.number.replace(/[\-\s]/g, function() { return '-' });
            gameid = v.gameid;
      ...
      gotoBetsFn() {
        ...
        let vote_no = regNum.replace(/[\-\s]/g, function() { return '-' });
        let vote_cash = vm.setMoneyFn();
