    ...
    data() {
      return {
        ...
        },
        {
          title: '组选',
          data: [
            { title: '组三复式', type: 'single', showOprateBtn: true, checked: false, unit: 2, betsTitle: ['组三'], betsMode: 2, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            ...
            { title: '组六复式', type: 'single', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['组六'], betsMode: 3, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
        ...
        twoStar: [
        {
          title: '直选',
          data: [
            { title: '(前二)排五直选复式', type: 'compound', showOprateBtn: true, checked: true, unit: 1, betsTitle: ['万位', '千位'], betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            { title: '(前二)排五直选单式', type: 'text', checked: false, checkBit: false, numLen: 2, isDouble: 2, order: false, valueLen: 0 }, // isDouble 0 三个值都不能一样, 1 可以有两个一样, 2 可以都一样, 3必须有两个值一样
            { title: '(后二)排五直选复式', type: 'compound', showOprateBtn: true, checked: true, unit: 1, betsTitle: ['十位', '个位'], betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            { title: '(后二)排五直选单式', type: 'text', checked: false, checkBit: false, numLen: 2, isDouble: 2, order: false, valueLen: 0 }, // isDouble 0 三个值都不能一样, 1 可以有两个一样, 2 可以都一样, 3必须有两个值一样
          ]
        },
        {
          title: '组选',
          data: [
            { title: '(后二)排五直选复式', type: 'single', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['组选'], betsMode: 2, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            { title: '(后二)排五直选单式', type: 'text', checked: false, checkBit: false, numLen: 2, isDouble: 0, order: true, valueLen: 0 }, // isDouble 0 三个值都不能一样, 1 可以有两个一样, 2 可以都一样, 3必须有两个值一样
            { title: '(前二)排五直选复式', type: 'single', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['组选'], betsMode: 2, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            { title: '(前二)排五直选单式', type: 'text', checked: false, checkBit: false, numLen: 2, isDouble: 0, order: true, valueLen: 0 }, // isDouble 0 三个值都不能一样, 1 可以有两个一样, 2 可以都一样, 3必须有两个值一样
          ]
        }],
        oneStar: [
        {
