      ...
      <div class="header-right">
        ...
        <div class="explain">
          <span>
            ...
            <router-link :to="{name:'cpwf',query:{s_p:'ssc'}}" target="_blank">玩法说明</router-link>
          </span>
          <span>
            <em class="explain-btn-bj"></em>
      ...
      <div class="lottery-content">
        <div class="lottery-top" style="min-height:520px;">
          <div class="lottery-num">
            <lotteryNumberArr v-if="isShowLotteryNum" :gameid="gameid" :issueArr="issueArr" :title="betsArr.item.title" :parTitle="groupName" :prize="c_prize" :prizeArea="prizeArea" :adjust="adjust" :userRefund="userRefund"></lotteryNumberArr>
          </div>
          <div class="bets-wrap-parent">
            <div class="bets-wrap">
              ...
              <betsAreaTen lotteryType="ssc" v-if="randerbetsAreaTen&&betsArr.type!=='text'" :betsArr="betsArr" @sendWei="handlesendWei" @sendProb="handlesendProb"></betsAreaTen>
          ...
          <div class="bets-result-wrap">
            <div class="bets-result-top">
              ...
              <div class="double">
                ...
                <span class="jianhao el-icon-minus" @click="handleJianMultiple">
                </span>
...
<script>
  ...
  import getLatestNumIssue from '@/lib/issue120_util.js';
  ...
  export default {
    ...
    data() {
      return {
        ...
        fiveStar: [
        {
          title: '直选',
          data: [
            // 投注方式(标题)，投注类型，是否显示操作按钮，标题是否选中，投注单位，投注标题(十位，百位...)，从数字中选出几个进行组合，是否包含对字号或豹子号，操作按钮的位置，是否显示垂直的操作按钮，是否有选中的单位,
            { title: '直选复式', type: 'compound', showOprateBtn: true, checked: false, unit: 1, betsTitle: bit, betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false },
            // 每一注的号码长度，是否排序(如果排序，说明注码不限顺序)，选中单位的内容
            { title: '直选单式', type: 'text', checked: false, checkBit: false, numLen: 5, isDouble: 2, order: false, checkLen: [] }, // isDouble 0 三个值都不能一样, 1 可以有两个一样, 2 可以都一样, 3必须有两个值一样
        ...
        fourStar: [
        {
          ...
          data: [
            ...
            { title: '直选单式', type: 'text', checked: false, checkBit: false, numLen: 4, isDouble: 2, order: false, valueLen: 0 }, // isDouble 0 三个值都不能一样, 1 可以有两个一样, 2 可以都一样
        ...
        topThreeStar: [
        {
          ...
          data: [
            ...
            { title: '直选单式', type: 'text', checked: false, checkBit: false, numLen: 3, isDouble: 2, order: false, valueLen: 0 }, // isDouble 0 三个值都不能一样, 1 可以有两个一样, 2 可以都一样, 3必须有两个值一样
        ...
        cenThreeStar: [
        {
          ...
          data: [
            ...
            { title: '直选单式', type: 'text', checked: false, checkBit: false, numLen: 3, isDouble: 2, order: false, valueLen: 0 },
            { title: '直选和值', type: 'and', showOprateBtn: true, checked: false, unit: 1, betsTitle: [''], betsMode: 1, isDouble: true, oprateBtn: 'bottom', vertOprate: false, checkBit: false, valueLen: 3 },
            { title: '直选跨度', type: 'diff', showOprateBtn: true, checked: false, unit: 1, betsTitle: [''], betsMode: 1, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false, valueLen: 3 },
        ...
        optional: [
        {
          ...
          data: [
            ...
            { title: '直选单式', type: 'text', checked: false, checkBit: true, numLen: 2, isDouble: 2, order: false, valueLen: 2, checkLen: ['十', '个'] }, // isDouble 0 三个值都不能一样, 1 可以有两个一样, 2 可以都一样, 3必须有两个值一样
            { title: '直选和值', type: 'optional-and', showOprateBtn: true, checked: false, unit: 1, betsTitle: [''], betsMode: 2, isDouble: true, oprateBtn: 'bottom', vertOprate: false, checkBit: true, valueLen: 2, checkLen: ['十', '个'] },
            { title: '组选复式', type: 'optional-compound', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['组选'], betsMode: 2, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: true, valueLen: 2, checkLen: ['十', '个'] },
            { title: '组选单式', type: 'text', checked: false, checkBit: true, numLen: 2, isDouble: 0, order: true, valueLen: 2, checkLen: ['十', '个'] }, // isDouble 0 三个值都不能一样, 1 可以有两个一样, 2 可以都一样, 3必须有两个值一样
            { title: '组选和值', type: 'optional-and', showOprateBtn: true, checked: false, unit: 1, betsTitle: [''], betsMode: 2, isDouble: false, oprateBtn: 'bottom', vertOprate: false, checkBit: true, valueLen: 2, checkLen: ['十', '个'] },
          ]
        },
        {
          title: '任选三',
          data: [
            { title: '直选复式', type: 'optional', showOprateBtn: true, checked: false, unit: 1, betsTitle: bit, betsMode: 3, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: false, valueLen: 3, checkLen: ['百', '十', '个'] },
            { title: '直选单式', type: 'text', checked: false, checkBit: true, numLen: 3, isDouble: 2, order: false, valueLen: 3, checkLen: ['百', '十', '个'] }, // isDouble 0 三个值都不能一样, 1 可以有两个一样, 2 可以都一样, 3必须有两个值一样
            { title: '直选和值', type: 'optional-and', showOprateBtn: true, checked: false, unit: 1, betsTitle: [''], betsMode: 3, isDouble: true, oprateBtn: 'bottom', vertOprate: false, checkBit: true, valueLen: 3, checkLen: ['百', '十', '个'] },
            { title: '组三复式', type: 'optional-compound', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['组选'], betsMode: 2, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: true, valueLen: 3, checkLen: ['百', '十', '个'] },
            { title: '组三单式', type: 'text', checked: false, checkBit: true, numLen: 3, isDouble: 3, order: true, valueLen: 3, checkLen: ['百', '十', '个'] }, // isDouble 0 三个值都不能一样, 1 可以有两个一样, 2 可以都一样, 3必须有两个值一样
            { title: '组六复式', type: 'optional-compound', showOprateBtn: true, checked: false, unit: 1, betsTitle: ['组选'], betsMode: 3, isDouble: true, oprateBtn: 'right', vertOprate: false, checkBit: true, valueLen: 3, checkLen: ['百', '十', '个'] },
            { title: '组六单式', type: 'text', checked: false, checkBit: true, numLen: 3, isDouble: 0, order: true, valueLen: 3, checkLen: ['百', '十', '个'] }, // isDouble 0 三个值都不能一样, 1 可以有两个一样, 2 可以都一样, 3必须有两个值一样
            { title: '混合组选', type: 'text', checked: false, checkBit: true, numLen: 3, isDouble: 1, order: true, valueLen: 3, checkLen: ['百', '十', '个'] }, // isDouble 0 三个值都不能一样, 1 可以有两个一样, 2 可以都一样, 3必须有两个值一样
            { title: '组选和值', type: 'optional-and', showOprateBtn: true, checked: false, unit: 1, betsTitle: [''], betsMode: 3, isDouble: false, oprateBtn: 'bottom', vertOprate: false, checkBit: true, valueLen: 3, checkLen: ['百', '十', '个'] },
          ]
        },
        {
          title: '任选四',
    ...
    methods: {
      ...
      // 设置投注时的奖金数
      setBetsPrize(prize) {
        return ((prize / this.userRefund) * this.adjust).toFixed(2)
      },
      // 获取从模块中返回的 投注的 数据
      ...
      setPrize() {
        ...
        // console.log(this.betsModeName)
        // let arr = this.betsArr.data[0].data;
        // console.log(this.betsArr)
        if (this.betsModeName.indexOf('直选复式') > -1 || this.betsModeName.indexOf('直选组合') > -1 || this.betsModeName.indexOf('混合组选') > -1 || this.betsModeName.indexOf('组选和值') > -1 || this.betsModeName.indexOf('包胆') > -1) {
          extra = ''
        }
        if (extra === '') {
          let p = this.prize;
          ...
          if (probArr.length === 1) {
            this.prizeArea = [min_prize.toFixed(2)];
          } else {
            this.prizeArea = [min_prize.toFixed(2), max_prize.toFixed(2)];
          }
        }
      },
      // 清除投注号
      ...
      getBetsNumber(val) {
        ...
        if (this.betsArr.type === 'text') {
          ...
          // if(this.betsArr.title === '龙虎和' && arr1.join("|").indexOf(this.betsArr.item.title) < 0){
          //   this.betsNumber = arr1.join("|") + ' ' + this.betsArr.item.title;
          // }else{
          //   this.betsNumber = arr1.join("|")
          // }
        }
      ...
      handleClickShop(item) {
        ...
        if (item.name.indexOf('单式') > -1) {
          ...
          if (arr[0] === '五星') {
            vm.filterShoppingCart(item, vm.fiveStar);
          } else if (arr[0] === '四星') {
            vm.filterShoppingCart(item, vm.fourStar);
          } else if (arr[0] === '前三') {
            vm.filterShoppingCart(item, vm.topThreeStar);
          } else if (arr[0] === '中三') {
            vm.filterShoppingCart(item, vm.cenThreeStar);
          } else if (arr[0] === '后三') {
            ...
            vm.filterShoppingCart(item, vm.optional)
          } else if (arr[0] === '龙虎') {
            vm.filterShoppingCart(item, vm.tiger)
          } else if (arr[0] === '和值') {
        ...
        request.http(
          ...
          (success) => {
            ...
            if (code === 103) {
              ...
              // vm.c_userRefund = Number(localStorage.getItem('refund')) - vm.diff;
      ...
      setInitData(data) {
        ...
        data.filter((v, vi) => {
          ...
          vm.navData.push(o);
          if (v.name === '五星') {
            vm.filterLotteryList(v.children, vm.fiveStar, v);
          } else if (v.name === '四星') {
            vm.filterLotteryList(v.children, vm.fourStar, v);
          } else if (v.name === '前三') {
            vm.filterLotteryList(v.children, vm.topThreeStar, v);
          } else if (v.name === '中三') {
            vm.filterLotteryList(v.children, vm.cenThreeStar, v);
          } else if (v.name === '后三') {
            ...
            vm.filterLotteryList(v.children, vm.optional, v);
          } else if (v.name === '龙虎') {
            vm.filterLotteryList(v.children, vm.tiger, v);
          } else if (v.name === '和值') {
      ...
      handleLotteryPlan(val) {
        ...
        // console.log(this['chaseData'+val])
      },
      ...
      profitChase(yinglilv, prize, onePrice, times, multipleBase, maxnum) {
        ...
        let issueArr = getLatestNumIssue.getLatestNumIssue(vm.s_code, vm.issue, Number(times))
        ...
        result.filter((v, i) => {
          ...
          let o = {
            ...
            prize: multiple * this.setBetsPrize(this.c_prize),
      ...
      multipleChaseFn(val, name) {
        ...
        let arr = [];
        let issueArr = getLatestNumIssue.getLatestNumIssue(vm.s_code, vm.issue, Number(issueTimes))
        // console.log(issueArr)
        ...
        if (data === 'chaseData1') {
          ...
          vm.chaseData1.filter((v, vi) => {
            ...
            if (v.multiple === 0) {
              ...
              v.prize = v.multiple * vm.setBetsPrize(vm.c_prize);
      ...
      confirmLotteryFn() {
        ...
        if (allBets != 0) {
          ...
          let unit; // 钱的 类型 元角分
          let prize = vm.setBetsPrize(vm.c_prize); // 奖金
...
<style scoped lang="scss">
  ...
  .bets-and-join button {
    ...
    margin-left: 12px;
    font-size: 14px;
    font-weight: 600; // background: -moz-linear-gradient(top, #FFB126 0%, #9A4E02 100%);
