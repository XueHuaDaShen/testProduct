<template>
  <div class="txsq-wrap">
    <div class="public-search-copy-header">
      ...
      <span class="title-text">提现申请</span>
    ...
    <datetime :class="showdatetime1?'showdatetime':''" datetimeWrapId='txsq-datetime-wrap1' timeType="yyyy-mm-dd hh:mm" :callback="getstart_time" :datetime="start_time"></datetime>
    <datetime :class="showdatetime2?'showdatetime':''" datetimeWrapId='txsq-datetime-wrap2' timeType="yyyy-mm-dd hh:mm" :callback="getend_time" :datetime="end_time"></datetime>
  </div>
</template>
<script>
