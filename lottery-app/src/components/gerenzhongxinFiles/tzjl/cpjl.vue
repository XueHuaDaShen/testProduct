<template>
  <div class="cpjl-wrap">
    <div class="public-search-copy-header">
      ...
      <span class="title-text">彩票记录</span>
    ...
    <datetime :class="showdatetime1?'showdatetime':''" datetimeWrapId='cpjl-datetime-wrap1' timeType="yyyy-mm-dd hh:mm" :callback="getstart_time" :datetime="start_time"></datetime>
    <datetime :class="showdatetime2?'showdatetime':''" datetimeWrapId='cpjl-datetime-wrap2' timeType="yyyy-mm-dd hh:mm" :callback="getend_time" :datetime="end_time"></datetime>
  </div>
</template>
<script>
import request from '@/axios/axios.js';
import {getVoteStatus} from '@/assets/js/filterStatus.js';
...
export default {
  ...
  data() {
    return {
      ...
      playGroups: [],
      playName: [],
      tableHead: ['游戏', '奖期', '玩法', '投注内容', '投注额', '奖金', '状态'],
      tableData: [],
      emptyText: '暂无数据',
      showSelect: true,
