        ...
        <div class="form">
          ...
          <div class="form-row form-cen">
            ...
            <div v-for="(item, index) in menuList" :key="index">
              <h2 class="form-cen-title"><el-checkbox v-model="checkedMenu[index].checkAll" @change="handleCheckAllChange($event, index)">{{item.menu_name}}</el-checkbox></h2>
        ...
        <div class="form">
          <el-table align="left" :data="membersData" empty-text="请添加成员">
            ...
            <el-table-column property="is_forbid" label="状态" width="200">
              <template slot-scope="scope">
                <el-switch v-model="scope.row.is_forbid" @change="handleChangeStatus(scope.row)" :active-value="0" :inactive-value="1" active-color="#13ce66"
