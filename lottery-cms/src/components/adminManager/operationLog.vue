  ...
  <div class="el-custom">
    ...
    <div class="data-table" v-loading="loading">
      <el-table :data="logListData" header-row-class-name="table-header" stripe border style="width: 100%;font-size:12px;"
        ...
        <el-table-column align="center" label="操作类型" width="200" prop="op">
        </el-table-column>
        ...
        <el-table-column align="center" prop="create_at" :formatter="formatTime" label="操作时间">
        </el-table-column>
      </el-table>
      <div class="fenye">
